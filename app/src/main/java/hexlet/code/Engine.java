...
public class Engine {
    ...
    public static void runGame(String gameName, Scanner scanner) {
        ...
        switch (gameName) {
            ...
            case "pro":
                ...
                break;
            case "prime":
                hexlet.code.games.Prime.start(scanner, name);
                break;
            default:
    ...
    public static boolean examination(String question, String correctAnswerStr, String userName) {// проверяем
        System.out.println("Question: " + question);
        System.out.print("Your answer: ");
        String userAnswerStr = SCANNER.nextLine().trim();

        if (userAnswerStr.equals(correctAnswerStr)) {//сравниваем
